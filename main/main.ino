...
void loop() {
  ...
  //  moveForward(0.0); // currently all motors going in reverse, motor1 slow (both directions active)
  //  delay(5000);
    
//    //Move backwards for 5 seconds
  //  moveBackward(0.0); // currently right motors going reverse, left not moving
  //  delay(5000);
//
